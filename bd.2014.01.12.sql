...
CREATE TABLE `agenda_reserva` (
  ...
  KEY `agenda_reserva_001f1fd2` (`tipoEvento_id`),
  KEY `agenda_reserva_c69e2c81` (`usuario_id`),
  KEY `agenda_reserva_cad1d7f2` (`departamento_id`),
  CONSTRAINT `tipoEvento_id_refs_id_f89e9eb4` FOREIGN KEY (`tipoEvento_id`) REFERENCES `agenda_tipoevento` (`id`),
  ...
  CONSTRAINT `usuario_id_refs_id_1f5f089c` FOREIGN KEY (`usuario_id`) REFERENCES `agenda_usuario` (`id`)
...
INSERT INTO `agenda_reserva` VALUES (1,'1','2015-01-11 12:00:00','2015-01-12 16:00:54','2015-01-12 16:00:54',3,6,1,1,1,'Teste Reserva');
...
CREATE TABLE `agenda_usuario` (
  ...
  `vinculo` smallint(5) unsigned NOT NULL,
  `idufsc` varchar(100) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `agenda_usuario` VALUES (1,'Ramon Dutra Miranda','ramon.rdm@ufsc.br',1,'ramon.rdm@ufsc.br');
...
INSERT INTO `auth_permission` VALUES (1,'Can add log entry',1,'add_logentry'),(2,'Can change log entry',1,'change_logentry'),(3,'Can delete log entry',1,'delete_logentry'),(4,'Can add permission',2,'add_permission'),(5,'Can change permission',2,'change_permission'),(6,'Can delete permission',2,'delete_permission'),(7,'Can add group',3,'add_group'),(8,'Can change group',3,'change_group'),(9,'Can delete group',3,'delete_group'),(10,'Can add user',4,'add_user'),(11,'Can change user',4,'change_user'),(12,'Can delete user',4,'delete_user'),(13,'Can add content type',5,'add_contenttype'),(14,'Can change content type',5,'change_contenttype'),(15,'Can delete content type',5,'delete_contenttype'),(16,'Can add session',6,'add_session'),(17,'Can change session',6,'change_session'),(18,'Can delete session',6,'delete_session'),(19,'Can add departamento',7,'add_departamento'),(20,'Can change departamento',7,'change_departamento'),(21,'Can delete departamento',7,'delete_departamento'),(22,'Can add espaco fisico',8,'add_espacofisico'),(23,'Can change espaco fisico',8,'change_espacofisico'),(24,'Can delete espaco fisico',8,'delete_espacofisico'),(25,'Can add tipo evento',9,'add_tipoevento'),(26,'Can change tipo evento',9,'change_tipoevento'),(27,'Can delete tipo evento',9,'delete_tipoevento'),(28,'Can add usuario',10,'add_usuario'),(29,'Can change usuario',10,'change_usuario'),(30,'Can delete usuario',10,'delete_usuario'),(31,'Can add reserva',11,'add_reserva'),(32,'Can change reserva',11,'change_reserva'),(33,'Can delete reserva',11,'delete_reserva');
...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$12000$fYjvpWHstnPp$PH4gCVaRJj63Zp7OA8NcOud4BfeyYlE2oQ+h1Tx+zBI=','2015-01-12 15:59:29',1,'admin','','','ramon.rdm@ufsc.br',1,1,'2015-01-12 15:59:08');
...
INSERT INTO `django_admin_log` VALUES (1,'2015-01-12 16:00:15','1','Ramon Dutra Miranda',1,'',10,1);
...
INSERT INTO `django_content_type` VALUES (1,'log entry','admin','logentry'),(2,'permission','auth','permission'),(3,'group','auth','group'),(4,'user','auth','user'),(5,'content type','contenttypes','contenttype'),(6,'session','sessions','session'),(7,'departamento','agenda','departamento'),(8,'espaco fisico','agenda','espacofisico'),(9,'tipo evento','agenda','tipoevento'),(10,'usuario','agenda','usuario'),(11,'reserva','agenda','reserva');
...
INSERT INTO `django_migrations` VALUES (1,'contenttypes','0001_initial','2015-01-12 15:58:45'),(2,'auth','0001_initial','2015-01-12 15:58:47'),(3,'admin','0001_initial','2015-01-12 15:58:48'),(4,'sessions','0001_initial','2015-01-12 15:58:48');
...
INSERT INTO `django_session` VALUES ('vs7e26vfd5bm7kmqky6cwhi8kv3ul8ub','OGViNzEzNzU5ODMxNThjMDE2ZjY2MmU3NDQ2OWQzZjI1Y2MwOGQwOTp7Il9hdXRoX3VzZXJfaGFzaCI6ImIwM2RlMWY4OWIyMGM3ZWRkMDBlNGM1M2FjYmMxODkzMGEzZjZjZDQiLCJfYXV0aF91c2VyX2JhY2tlbmQiOiJkamFuZ28uY29udHJpYi5hdXRoLmJhY2tlbmRzLk1vZGVsQmFja2VuZCIsIl9hdXRoX3VzZXJfaWQiOjF9','2015-01-26 15:59:29');
...
-- Dump completed on 2015-01-12 18:15:38
