...
urlpatterns = [
    ...
    url(r"^calendar/(e|f|s)/(\d+)/(\d+)/(\d+)/(prev|next)/$", views._calendar, name="mes"),
    url(r"^calendar/(e|f|s)/(\d+)/(\d+)/(\d+)/$", views._calendar, name="mes"),
    url(r'^calendar/(e|f|s)/(\d+)/$', views._calendar, name='mes'),
    #dia, mes, ano, 
