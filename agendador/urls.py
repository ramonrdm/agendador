...
urlpatterns = [
    ...
    url(r'^accounts/login/', views.login_email, {"template_name":"agenda/login.html"}, name="login_normal"),
    url(r'^accounts/loginemail/', views.login_email, {"template_name":"agenda/login.html"}, name="login_normal"),
    ...
    url(r'^estatisticas/$', views.statistics, name="estatisticas"),
